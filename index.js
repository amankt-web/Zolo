...
menuItems.forEach(item => {
    item.addEventListener('click', () => {
        ...
        // Check if the clicked item is the 'notification' item
        if (item.id !== 'notification') {
            // If not, hide the notification popup
            document.querySelector('.notification-popup').style.display = 'none';
        } else {
            // If yes, show the notification popup and hide the notification count
